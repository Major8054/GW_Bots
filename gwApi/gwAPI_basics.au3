...
Func InitClient($aCharname = '')
   ...
   DllStructSetData($mMaxAttributes, 3, $HEADER_SET_ATTRIBUTES)
   DllStructSetData($mMaxAttributes, 5, $HEADER_MAX_ATTRIBUTES_CONST_5)
   DllStructSetData($mMaxAttributes, 22, $HEADER_MAX_ATTRIBUTES_CONST_22)
