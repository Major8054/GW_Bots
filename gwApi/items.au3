...
Func UpgradeArmor($aArmor, $aUpgrade)
   ...
   Sendpacket(0xC, $HEADER_UPGRADE_1, $lSessionID[1], $lArmorID)
   PingSleep(125)
   Sendpacket(0x4, $HEADER_UPGRADE_2)
