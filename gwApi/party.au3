...
Func InvitePlayerByPlayerNumber($lPlayerNumber)
   Return SendPacket(0x8, $HEADER_INVITE_TARGET, $lPlayerNumber)
...
Func InvitePlayerByID($aAgentID)
   ...
   EndIf
   If $lAgentPlayerNumber <> 0 Then Return SendPacket(0x8, $HEADER_INVITE_TARGET, $lAgentPlayerNumber)
...
Func LeaveGroup($aKickHeroes = True)
   If $aKickHeroes Then SendPacket(0x8, $HEADER_PARTY_LEAVE, 0x26)
