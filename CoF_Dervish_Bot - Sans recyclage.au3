...
Func Setup()
   If GetMapID() <> $MAP_ID_DOOMLORE Then
	  ...
	  Waitmaploading($MAP_ID_DOOMLORE) ; test
   EndIf
...
Func CanPickUp($lItem)
 ...
 ;  If $ModelID = 22269 Then Return True ; cupcakes
  ; If $ModelID = 28435 Then Return True ; cidre
   ...
   If $modelid = 28435 Then Return False ; cidre
   If $modelid = 910 Then Return False ; bière
   If $modelid = 18345 Then Return True ; trophée
   If $modelid = 26784 Then Return False ; miel
   If $modelid = 21810 Then Return False ; canon
   If $modelid = 21813 Then Return False ; cierge
   If $modelid = 21812 Then Return False ; boisson sucrée
   If $modelid = 21809 Then Return False ; fusée
   If $modelid = 35124 Then Return False ; cognac
   If $modelid = 21810 Then Return False ; canon
...
Func exeption($item)
   ...
   If $ModelID = 21266 Then Return False ; faux de corruption

   If $ModelID = 1861 Then Return True
   If $ModelID = 157 Then Return True
   If $ModelID = 257 Then Return True
   If $ModelID = 2266 Then Return True
   If $ModelID = 255 Then Return True
   If $ModelID = 251 Then Return True
   If $ModelID = 2254 Then Return True
   If $ModelID = 2040 Then Return True
   If $ModelID = 1829 Then Return True
   If $ModelID = 1834 Then Return True
   If $ModelID = 2109 Then Return True
   If $ModelID = 1871 Then Return True
   ...
   If $ModelID = 2224 Then Return True
   If $ModelID = 1869 Then Return True
   If $ModelID = 1857 Then Return True
   If $ModelID = 1815 Then Return True
   If $ModelID = 1793 Then Return True
   If $ModelID = 1917 Then Return True
   If $ModelID = 1858 Then Return True
   If $ModelID = 1832 Then Return True
   If $ModelID = 198 Then Return True
   If $ModelID = 1859 Then Return True
   If $ModelID = 1786 Then Return True
   If $ModelID = 1856 Then Return True
   If $ModelID = 2225 Then Return True
   If $ModelID = 269 Then Return True
   If $ModelID = 1914 Then Return True
   If $ModelID = 1792 Then Return True
   If $ModelID = 2218 Then Return True
   If $ModelID = 2111 Then Return True
...
Func AfterRun($aBags = 4)
	...
	If CountSlots() < 6 Then
		Sleep(2000)
		GoNearestNPCToCoords(-18068.31, 18428.51)
		Merchant()
		RndSleep(1000)
		Ident(1)
		Ident(2)
...
Func SellLoot(); pas encore fait
   ...
   Next
EndFunc
Func CandSellLoot($aItem)
   	Local $m = DllStructGetData($aItem, 'ModelID')
	Local $t = DllStructGetData($aItem, 'Type')
	Local $e = DllStructGetData($aItem, 'Extrald')
    ...
    If DllStructGetData($aItem, "Equiped") <> 0 Then Return False
		;Out("CSDM initC")
    If exeption($aItem) Then Return True;False
