   ...
   EndFunc
	...
	Func GetCanSalvage($aitemptr)
		...
		; EndSwitch
		 ...
		 If $lmodelid = 146 Then Return False ; dye
		 If $lmodelid = 946 Then Return False ; bois
		 If $lmodelid = 930 Then Return False ; ectos
		; If $lmodelid = 945 Then Return False ; frags
		 If $lmodelid = 938 Then Return False ; saphiSrs
		 If $lmodelid = 937 Then Return False ; rubis
		 If $lmodelid = 934 Then Return False ; fibres
		 If $lmodelid = 948 Then Return False ; fer
		 If $lmodelid = 929 Then Return False ; dust
		 If $lmodelid = 955 Then Return False ; granite ; même id que boclier décoré?
		 If $lmodelid = 819 Then Return False ; racines
		 If $lmodelid = 22280 Then Return False ; parcho fow
		 If $lmodelid = 22751 Then Return False ; lockpicks
	     If $lmodelid = 2992 Then Return False ; salvage kit
	     If $lmodelid = 2989 Then Return False ; ID kit
		 If $lmodelid = 956 Then Return False ; boispirite

		; If $lmodelid = 955 Then Return True ; bouclier décoré
	...
	;	 Switch GetRarity($aItemptr)
	;		Case 2621
	;		Case 2623, 2624, 2626
	;			If Not GetIsIDed($aItemptr) Then Return False
	;		Case Else
	;			Return True
	;	EndSwitch
