...
Func EnterQuest()
	...
	If $OutPostMapID = $KamaMapID Then
		$lGrenth = GetNearestNPCToCoords(-10937, 14498)
	Else
...
Func Disconnected1() ;Ralle's Disconnect ;
	Out("Disconnected!")
...
Func Checkmap()
	If GetMapID() <> $KamaMapID	Then	;; Starting Map is 819, ID: Kamadan Jewel of Istan - Wintersday
		Out("Mapping to Kamadan")
		RndTravel($KamaMapID)
	EndIf
EndFunc   ;==>Checkmap
...
Func CountItemInBagsByModelID4($ItemModelID) ;
	$count = 0
...
; ceci n'a rienb a voir avec le bot
;
	;	MoveTo(-8298, 14017)
	;			GoToNPCNearestCoords(-9275, 14283)  ; Elder Skruuj
	;	MoveTo(-9682, 14391)
	;	MoveTo(-10214, 14436)
	;	MoveTo(-10869, 14492)
	;	GoToNPCNearestCoords(-10937, 14498)  ; Rift Warden
